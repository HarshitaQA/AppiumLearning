...
public class HomePageTest {
    @Test
    public void VerifyUserIsAbleToGoToProductsPageAfterClickingOnLetsShopButton() throws MalformedURLException {
    ...
    @Test
    public void VerifyItemsAreAddedToCartAfterClickingOnAddToButtonOnProducts() throws MalformedURLException {
        ...
        String number = driver.findElement((AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.androidsample.generalstore:id/counterText\"]"))).getText();
